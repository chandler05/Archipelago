...
location_table: List[LocationInfo] = [
    ...
    {"name": "Have 30 Gold", "id": base_id + 55, "game_id": "have_30_gold", "potentialBoosterPacks": ["Mainland"], "ideas": ["Idea: Market"]},
    {"name": "Have 50 Gold", "id": base_id + 56, "game_id": "have_50_gold", "potentialBoosterPacks": ["Mainland"], "ideas": ["Idea: Market"]},
